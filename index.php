...
<li><a href="logout.php?logout">Log out/in</a></li> 
      ...
      <p id="summary"> <img src="Images/kauai.png"><br> Thank you for visiting Pegasus E-Travel, You may vist the Browse page to take a look at our luxurious packages.<br>Only memebers will be able to navigate to shop and forums page, please click the button to  create an account!.<br>Pegasus E-Travel specializes in booking group travel plans all under one package price;<br> Makeing it extrelmely easy to book family reunions,company excursions and retreats.<br>Book your travel destination now!<br><br><a href="register.php">Sign up</a><br><br> </p>
